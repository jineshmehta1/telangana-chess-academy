...
export function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      content:
        "Never thought I could learn chess at 65, but the patient instructors proved me wrong. Chess has become my favorite hobby and mental exercise.",
